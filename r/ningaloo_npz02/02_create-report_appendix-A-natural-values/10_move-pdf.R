...
pdf_name  <- "Project 4.21-Ningaloo-2-Appendix A2-q-Natural values.pdf"
html_name <- "Project 4.21-Ningaloo-2-Appendix A2-q-Natural values.html"

# The appendix folder is wherever this script lives, so the npz build
# (r/ningaloo_npz02/...) is picked up without editing a hard-coded path.
