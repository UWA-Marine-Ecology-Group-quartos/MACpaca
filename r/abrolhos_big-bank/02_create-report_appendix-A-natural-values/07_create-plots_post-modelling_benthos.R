...
# Map pretty habitat names to raster layer prefixes in datt
habitat_lookup <- c(
  "Sand" = "sand",
...
# TODO Plot extent
prediction_limits <- c(113, 113.3, -27.2, -27.05)
...
ggsave(
  ...
  plot = p_reef, height = 4, width = 10, dpi = 300, units = "in", bg = "white"
)
...
site_limits <- c(113, 113.3, -27.2, -27.05) # TODO set limits
