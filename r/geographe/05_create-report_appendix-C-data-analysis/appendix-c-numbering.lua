...
#
# Appendix C numbers its figures flat as "C.<n>" across the whole appendix,
# and the two habitat response-curve figures as "C.<parent>.<n>". All of
...
local sub_mode  = false  -- inside the C.y.z block?
