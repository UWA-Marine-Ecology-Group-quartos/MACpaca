...
# Row order in Table C.1 / C.2 and on the heatmaps. Seagrass is not modelled
# (>80% zeros) so it is not listed here; Kelp is modelled as its own habitat
# class (split out of Macroalgae in 01_call-API.R).
habitat_response_order <- c("macroalgae", "sand", "kelp", "rock",
