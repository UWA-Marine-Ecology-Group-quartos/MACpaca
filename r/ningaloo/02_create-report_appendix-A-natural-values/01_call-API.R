...
# Synthesis 89 = Ningaloo stereo-BRUVs
CheckEM::ga_api_all_data(synthesis_id = "89",
                         token = token,
...
# BOSS ----
# Synthesis 88 = Ningaloo BOSS (drop-camera)
...
# on the other and bind_rows() errors out. Reconcile every shared column whose
# type differs rather than patching them one at a time, since which columns
# clash changes from synthesis to synthesis.
...
# TODO Check status is populated for the BOSS samples - synthesis 89 returns
...
# outside Ningaloo that BOSS campaigns fall within - check whether those
# campaigns belong in this report
sample_zones %>%
...
# TODO Check the sample numbers match what you expect from the field, and copy
# the survey years shown here into years / fish_years in 00_config.yml
