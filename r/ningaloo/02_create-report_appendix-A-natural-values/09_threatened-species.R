...
# TODO Set cropping extent - larger than the plot window. Ballpark for
# Ningaloo, check and adjust
...
year_colours <- c("2019" = "#9C27B0", "2021" = "#1E88E5",
                   "2022" = "#43A047", "2024" = "#009688")
