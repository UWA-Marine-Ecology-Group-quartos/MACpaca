...
pdf_name <- "Project 4.21-Swc_easternarm-2-Appendix A-q-Natural values.pdf"
html_name <- "Project 4.21-Swc_easternarm-2-Appendix A-q-Natural values.html"
html_files_dir <- "09_quarto_files" # supporting folder Quarto generates alongside the HTML
source_dir <- paste0("r/", park,
